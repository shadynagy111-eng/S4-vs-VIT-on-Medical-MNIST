# -*- coding: utf-8 -*-
"""vit-on-pathmnist28.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1oWTZiI7yIsXtJqfQCj0WUz9PexCZ4zfb
"""
...
# Initialize
model = ViT2D(num_classes=9, image_size=(28, 28), patch_size=(4, 4), embed_dim=768, num_heads=8, num_layers=8, mlp_dim=256)
model.to(device)
...
transform = transforms.Compose([
            ...
            transforms.Lambda(lambda x: x.view(3, 28,28))
        ])
...
model_stats = summary(model, input_size=(1, 3, 28, 28),
