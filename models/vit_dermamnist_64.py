# -*- coding: utf-8 -*-
"""vit-dermamnist-64.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/13Lblu8jD2tx5T5gQ_Sg_YPo7QfY0tu8B
"""
...
validation_dataset = DermaMNIST(split="val", download=True,size=64)
validation_dataset
...
transform = transforms.Compose([
            transforms.ToTensor(),
            transforms.Lambda(lambda x: x.view(3, 64,64))
        ])
...
model_stats = summary(model, input_size=(1, 3, 64, 64),
